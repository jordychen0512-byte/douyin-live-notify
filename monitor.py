...
STREAMERS = {
    ...
    "23531668627": {
        "name": "當代選手｜争锋瑾",
        "url": "https://live.douyin.com/23531668627",
    },
}
...
async def check_stream(streamer):
    ...
    data = await live.fetch_web_stream_data(
        streamer["url"]
    )
